...
6. EXTREMELY IMPORTANT: DO NOT copy and paste the raw context blocks (e.g. "[Document 1] Source: ..."). You must synthesize the information into a natural, conversational answer in paragraph format. Put the family-facing text in the answer field. Never write "Here's a thinking process", numbered analysis steps, or other hidden reasoning.
